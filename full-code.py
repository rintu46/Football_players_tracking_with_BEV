...
# Get the output layer indices as a list of integers
...
# if all(0 <= idx < len(layer_names) for idx in output_layer_indices):
#     output_layers = [layer_names[i - 1] for i in output_layer_indices]
# else:
#     print("Invalid layer indices obtained from net.getUnconnectedOutLayers()")
